...
window.addEventListener('DOMContentLoaded', () => {
  ...
  function showModalByScroll() {
    if (window.pageYOffset + document.documentElement.clientHeight >= document.documentElement.scrollHeight && modalCounter == 0) {
      openModal();
      clearInterval(modalTimerId);
  ...
  window.addEventListener('scroll', showModalByScroll); // Use classes for cards
